...
% 
% Many links are in vertical bars, like this: |\texttt{:h bars}|.
...
% 
% Other subjects can be found with the ":help" command, see |\texttt{:h help.txt}|.
% 
% The bars and stars are usually hidden with the |\texttt{:h conceal}| feature.
% They also
% use |\texttt{:h hl-Ignore}|, using the same color for the text as the background.
% You can
