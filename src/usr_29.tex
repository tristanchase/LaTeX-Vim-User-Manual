...
The \verb!'taglength'! option can be used to tell Vim the number of significant characters in a tag.
...
In C code blocks are enclosed in \verb!{}.!
...
It skips over pairs of \verb!{}! at the same level.
...
The next level of \verb!{}! is for a method.
...
The "\verb![(!" and "\verb!])!" commands work similar to "\verb![{!" and "\verb!]}!", except that they work on () pairs instead of \verb!{}! pairs.
