...
You will find hints for the translation in "\verb!$VIMRUNTIME/lang/README.txt!".
...
If the default \verb!'fileencodings'! value is not good for you, set it to the encodings you want Vim to try.
