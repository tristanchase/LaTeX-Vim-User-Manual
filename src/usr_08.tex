...
More commands to move to other windows: |\texttt{:h Q_wi}|.
...
The line marked with "\texttt{<- changed line}" is highlighted, and the inserted text is displayed with another color.
