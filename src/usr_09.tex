...
This removes the \verb!'T'! flag from the \verb!'guioptions'! option.
...
This is useful in diff mode, or when the \verb!'wrap'! option has been reset (more about that later).
...
This can be done with a menu item, or with the \verb!'guioptions'! option:

 \begin{Verbatim}[samepage=true]
 :set guioptions+=l
 \end{Verbatim}

This adds the \verb!'l'! flag to \verb!'guioptions'!.
...
\begin{center}\begin{longtable}{l l}
				\verb!'mouse'! & in which mode the mouse is used by Vim \\
				\verb!'mousemodel'! & what effect a mouse click has \\
				\verb!'mousetime'! & time between clicks for a double-click \\
				\verb!'mousehide'! & hide the mouse while typing \\
				\verb!'selectmode'! & whether the mouse starts Visual or Select mode \\
\end{longtable}\end{center}
...
You can tune the way Select mode works with the \verb!'selectmode'! option.
\clearpage
