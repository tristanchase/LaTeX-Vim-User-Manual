...
Adding an exclamation mark changes it into doing nothing, so that you can add the shell command to execute the rest of the file. |:\verb0#!0| |\verb!:h \verb!-S!!|
...
Using references to other parts of the help in \verb!|\verb!:h !|! is recommended.
