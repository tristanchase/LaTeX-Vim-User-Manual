...
Using the \verb!'ruler'! option has the advantage that it doesn't take much room,
...
The \verb!^! character matches the beginning of a line.
...
To go to a mark, use the command \verb!`{mark}!, where \verb!{mark}! is the mark letter.
